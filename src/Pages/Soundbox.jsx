...
import "./Soundbox.css"; // Import the separate CSS file
...
const Soundbox = () => {
  ...
  // Mouse glow – single listener + refs
  useEffect(() => {
    ...
    <div className="soundbox-app">
          ...
          <div className="hero-grid">
            <div className="hero-text">
              <h1 className="hero-title">
                Spay Smart Soundbox
                <span className="hero-subtitle">Instant Voice Alerts</span>
              </h1>
      ...
      <section className="features-section">
        ...
        <div className="features-content">
          <h2 className="features-title">Why Choose Spay Soundbox?</h2>
          ...
          <div className="features-grid">
            {features.map((feature, index) => (
              <div
                ...
                className={`feature-card ${isVisible[`f-${index}`] ? "visible" : ""}`}
      ...
      <section className="setup-section">
        <div className="setup-grid">
          ...
          <div className="setup-content">
            <h2 className="setup-title">Easy 4-Step Setup</h2>
              ...
              {accordionItems.map((item, index) => (
                <div key={index} className="accordion-item">
                  ...
                  >
                    ...
                    <svg
                      className={`accordion-icon ${openAccordion === index ? "rotated" : ""}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div
                    className={`accordion-content-wrapper ${openAccordion === index ? "expanded" : "collapsed"}`}
                  >
