...
import soundboxImg from '../assets/images/soundbox.webp';
...
const Soundbox = () => {
  ...
  return (
    <div className="soundbox-container font-sans">
      ...
      <div className="relative w-full min-h-[500px] sm:min-h-[550px] md:min-h-[600px] overflow-hidden flex items-center">
        {/* Background image */}
        <div
        ...
        <div className="relative container mx-auto px-4 sm:px-6 z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              ...
              >
                <div className="relative h-full p-5 sm:p-6 bg-white/95 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-100 overflow-hidden">
                  <div className="absolute inset-0 bg-navy-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                  <div className="relative mb-4">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-gradient-to-br from-navy-100 to-navy-200 
                        p-3 sm:p-4 text-navy-900 transform group-hover:scale-110 group-hover:rotate-2 
                        transition-all duration-500 shadow-md group-hover:shadow-lg">
                      {feature.icon}
                    </div>
                    <div className="absolute -top-1 -right-1 w-3 h-3 bg-navy-500 rounded-full border-2 border-white"></div>
                  </div>
