...
import autopayVisual from "../../assets/images/upi-autopay-13.png";
				...
				<div className="grid items-center gap-10 lg:grid-cols-[1.04fr_0.96fr] lg:gap-14">
					<div className="space-y-7 text-center md:text-left">
						...
						<p className="mx-auto mt-4 max-w-2xl text-sm sm:text-base text-gray-600 leading-relaxed lg:mx-0">
							Spay Fintech enables businesses to collect subscription fees, membership payments, EMI collections, and recurring invoices through UPI AutoPay. Reduce manual payment collection efforts and improve on-time payment success rates.
						</p>
						...
						<div className="relative">
							...
							<div className="relative">
								<img
									...
									className="h-[300px] w-full rounded-[1.2rem] object-cover sm:h-[430px] md:h-[440px]"
								/>
