...
import autopayVisual from "../../assets/images/payout-services-in-mumbai.png";

// const trustPoints = [
//     "Instant vendor payouts",
//     "NPCI-approved transfers",
...
const Section1 = () => {
    return (
        <section className="relative overflow-hidden bg-[#f2f5fb]" style={{ fontFamily: "Poppins, sans-serif" }}>
            ...
            <div className="relative mx-auto max-w-7xl px-6 py-14 md:px-10 md:py-20 lg:py-25">
                <div className="grid items-center gap-10 lg:grid-cols-[1.04fr_0.96fr] lg:gap-14">
                    <div className="space-y-7 text-center md:text-left">
                        <p className="inline-flex items-center gap-2 border-l-2 border-[#1099d0] pl-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#0f3d91]">
                            Payout services for fast vendor settlements
                        </p>

                        <h1 className="mt-3 text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight">
                            Scale your payouts with
                            <span className="block bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                                reliable, compliant transfers.
                            </span>
                        </h1>

                        <p className="mx-auto mt-4 max-w-2xl text-sm sm:text-base text-gray-600 leading-relaxed lg:mx-0">
                            Spay Fintech payout services simplify mass disbursements, payroll, vendor settlements, and supplier payments with instant UPI and IMPS transfers. Automate reconciliation, reduce failed settlements, and stay NPCI compliant while improving cash flow visibility.
                        </p>

                        {/* <div className="grid gap-3 sm:grid-cols-3">
                            {trustPoints.map((point) => (
                                <div key={point} className="rounded-2xl border border-slate-200 bg-white/90 px-4 py-3 text-sm font-medium text-slate-700 shadow-sm">
                                    {point}
                                </div>
                            ))}
                        </div> */}
                    ...
                    <div className="upi-hero-rise mx-auto w-full max-w-xl lg:ml-auto lg:mr-0" style={{ animationDelay: "220ms" }}>
                        <div className="relative">
                            ...
                            <div className="relative">
                                <img
                                    src={autopayVisual}
                                    alt="Spay payout dashboard preview"
                                    className="h-[285px] w-full rounded-[1.2rem] object-cover sm:h-[375px] md:h-[375px]"
                                />
